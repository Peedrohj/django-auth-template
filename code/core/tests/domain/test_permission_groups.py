...
class TestPermissionGroup(unittest.TestCase):
    def setUp(self) -> None:
        self.permission = Permission(name="Test", codename="Test", content_type=ContentType(app_label="Test", model="Test"))
    ...
    def test_create_permission_group(self):
        ...
        self.assertEqual(permission_group.name, self.permission_group_props["name"])
        self.assertEqual(permission_group.permissions, self.permission_group_props["permissions"])
    ...
    def test_cannot_create_permission_group_with_invalid_permissions(self):
        with self.assertRaises(InvalidPermissionException):
            ...
            permission_group = PermissionGroup(**invalid_permission_group_props)
